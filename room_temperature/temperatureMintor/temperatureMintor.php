<?php
require '../dadb.php';
$NowTime="2020-08-02 02:07:15";
$sql="select * from temperature where dateTime='$NowTime'";
$array=array();
	$res=$conn->query($sql);
	if ($res) {
...
<div class="rightContent">
	...
	<div class="nav3-box">
		...
		<form class="bs-example bs-example-form" role="form" id="search" action="/room_temperature/search/search.php" method="post">
			<div  id="searchBorder">
