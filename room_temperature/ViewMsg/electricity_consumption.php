...
<div class="rightContent">
	...
	<div id="smallNav">
		<ul class="nav nav-tabs">
			<li class="active"><a href="?type=PDU">电路用电</a></li>
			<li><a href="?type=KT">各组件用电</a></li>
		</ul>
	</div>
<?php
	require '../dadb.php';
	$res="select * from electricity_consumption order by idEC DESC limit 20";
	$array=array();
	$sql=$conn->query($res);
	if ($sql) {
		...
		echo '<script>alert("打开页面失败，请联系管理员");</script>';
}
if (isset($_GET['type'])) {
	$type=$_GET['type'];
}else{
